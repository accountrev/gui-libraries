...
do
	...
	function utility:RandomizedString(length)
		local randomizedStringArr = {}

		for i = 1, length do
			randomizedStringArr[i] = string.char(math.random(32,126))
		end

		return table.concat(randomizedStringArr)
	end
end
...
do
	...
	function library:Notify(data)
		...
		local soundType = data.soundType or "main"
		...
		sound.SoundId = "rbxassetid://" .. typeSounds[soundType]
	...
	function section:updateDropdown(module, aOptions)
		...
		if (not aOptions.noOpen) then
			utility:Tween(dropdown, {Size = UDim2.new(1, 0, 0, (entries == 0 and 30) or math.clamp(entries, 0, 3) * 34 + 120)}, 0.3)
...
print("Venyx sucessfully loaded!")
